...
Agent.prototype.plan=function(enverionment){};
...
Pelota.prototype.sense=function(environment){
  ...
  if((obstaculo1.lenght>0 && (obstaculo1[0].distance<=this.radius)) || (obstaculo2.lenght>0 && (obstaculo2[0].distance<=this.radius)))
    this.colision=1;
  else
    this.colision=0;
};
