...
var material=new THREE.MeshLambertMaterial({color: 0xEEEED8});
var torreBlancaMalla=new THREE.Mesh(torreForma,material);

torreBlancaMalla.rotateX(Math.PI/2);
torreBlancaMalla.scale.set(0.05,0.05,0.05)
